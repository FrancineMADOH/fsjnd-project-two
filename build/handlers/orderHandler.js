...
var orderHandler = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, order.show(user)];
                    case 1:
                        userOrders = _a.sent();
                        res.status(200);
                        res.json(userOrders);
    ...
    orderHandler.prototype.completed = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, status, completedorders;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = parseInt(req.params.id);
                        status = req.params.status;
                        return [4 /*yield*/, order.completed(user, status)];
                    case 1:
